VERSION 5.00
Begin VB.Form SAL_SLN_CUST_PARAMETER 
   ...
   End
End
Attribute VB_Name = "SAL_SLN_CUST_PARAMETER"
...
Private Sub Form_Load()
   ...
   Set salSlnDyn = SalSlnDatabase.CreateDynaset("select sale_sln from hrishi.sale_detail where type_of_cust='customer'", &H4&)
...
Private Sub OKButton_Click()
 ...
 If saleSlnCombo.Text <> "" Then
  ModuleVarious.salSlnCust = saleSlnCombo.Text
  SANPROJECT.formShow
  Unload Me
 End If
