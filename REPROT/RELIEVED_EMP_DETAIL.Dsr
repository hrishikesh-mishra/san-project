VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} RELIEVED_EMP_DETAIL 
   Bindings        =   "RELIEVED_EMP_DETAIL.dsx":0000
   Caption         =   "RELIEVED EMPLOYEE DETAIL [ALL]"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item9 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   3015
         Object.Height          =   570
         Picture         =   "RELIEVED_EMP_DETAIL.dsx":0020
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "RELIEVED_EMP_DETAIL"
